        ...
        <div className="hidden lg:flex w-full lg:w-1/2 login_img_section
          ...
          <div className="w-full mx-auto px-20 flex-col items-center space-y-6">
            ...
            <div className="flex justify-center lg:justify-start mt-6">
              <a href="/login" className="hover:bg-indigo-700 hover:text-white hover:-translate-y-1 transition-all duration-500 bg-white text-indigo-800 mt-4 px-4 py-2 rounded-2xl font-bold mb-2">Get Started</a>
            </div>
          </div>
        </div>
          ...
          <div className="w-full px-8 md:px-32 lg:px-24">
            <form className="bg-white rounded-md shadow-2xl p-5">
              ...
              <div className="flex justify-between mt-4">
                ...
                <a href="/login" className="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all">Don`t have an account yet?</a>
              </div>
